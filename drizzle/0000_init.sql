CREATE TYPE "public"."site_status" AS ENUM('pending', 'verified', 'needs_fix', 'failed');--> statement-breakpoint
...
CREATE UNIQUE INDEX "sites_user_domain_uniq" ON "sites" USING btree ("user_id","domain");--> statement-breakpoint
CREATE UNIQUE INDEX "sites_verified_domain_uniq" ON "sites" USING btree ("domain") WHERE "sites"."ownership_verified_at" IS NOT NULL;--> statement-breakpoint
